...
# 注意
    尽量是用bazelisk  而非使用 bazel ,原因在于前者可以管理多个bazel版本,可以运行不同的项目中.
...
### 查询 @pip_deps2存在的targets
    bazelisk query @pip_deps2//...  

# Clion
## currently only clion 2024.03.* can debug python code
